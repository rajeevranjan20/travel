          ...
          <div className="container">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-center">
              ...
              <div className="flex flex-col justify-center gap-6 sm:pt-0 lg:px-16">
                ...
                >
                  Explore all corners of The Jharkhand with us
                </h1>
                <p
                  data-aos="fade-up"
                  className="text-sm text-gray-500 tracking-wide leading-8"
                >
                 Jharkhand, nestled in the eastern part of India, is a state brimming with natural wonders, cultural diversity, and historical significance.
                  <br />
                </p>
